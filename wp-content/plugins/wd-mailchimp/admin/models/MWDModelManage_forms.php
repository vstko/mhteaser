...
class MWDModelManage_forms {
	...
	public function merge_vars( $merge_var ) {
		...
		if ( isset( $merge_var['dateformat'] ) ) {
			$array['dateformat'] = $merge_var['dateformat'];
		}

		if ( isset( $merge_var['defaultcountry_cc'] ) ) {
			$array['defaultcountry_cc'] = $merge_var['defaultcountry_cc'];
		}
