...
if( ! function_exists( 'sc_icon_bar' ) )
{
    ...
    // This variable has been safely escaped above in this function
		$output = '<a href="'. esc_url( $link ) .'" class="icon_bar '. esc_attr( $class ) .'" '. $target_escaped .'>';
			$output .= '<span class="t"><i class="'. esc_attr( $icon ) .'"></i>';
			$output .= '</span><span class="b"><i class="'. esc_attr( $icon ) .'"></i></span>';
		$output .= '</a>'."\n";
			...
			if( $animate ) $output .= '<div class="animate" data-anim-type="'. $animate .'">';
				...
				$output  .= '<div class="image_frame photo no_link scale-with-grid">';
					$output .= '<div class="image_wrapper">';
						...
						if( $link ) $output .= '<a href="'. $link .'" '. $target_escaped .'>';
...
if( ! function_exists( 'sc_map' ) )
{
	function sc_map( $attr, $content = null )
	{
		...
		$output .= '<div class="google-map-wrapper '. $class .'">';
			...
			$output .= '<div class="google-map" id="google-map-area-'. $uid .'" style="width:100%; height:'. intval( $height, 10 ) .'px;">&nbsp;</div>';
...
if( ! function_exists( 'sc_bar' ) )
{
	function sc_bar( $attr, $content = null )
	{
		...
		if( $size ) $size = 'style="height:'. intval( $size, 10 ) .'px"';
